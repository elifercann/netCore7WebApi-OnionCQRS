...
namespace Application.Features.Auth.Command.Login
{
    public class LoginCommandHandler : BaseHandler, IRequestHandler<LoginCommandRequest, LoginCommandResponse>
    {
        ...
        public async Task<LoginCommandResponse> Handle(LoginCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            _=int.TryParse(configuration["JWT:RefreshTokenValidityInDays"], out int refreshTokenValidityInDays);//boşluğa atıyor değeri
            ...
            string _token=new JwtSecurityTokenHandler().WriteToken(token);//jwt ile token yazdırılıyor ve yazdırılan token string değerinde oluyor
